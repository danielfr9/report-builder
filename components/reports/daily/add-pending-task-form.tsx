...
const AddPendingTaskForm = ({ onAdd }: AddPendingTaskFormProps) => {
  const [formData, setFormData] = useState<Omit<DailyPendingTask, "id">>({
    name: "",
    storyPoints: 1,
    actionPlan: "",
    image: undefined,
  ...
  return (
    <div className="border-2 border-dashed border-primary/50 rounded-lg p-4 space-y-3 bg-primary/5">
      <div className="flex items-center">
        <h3 className="font-medium">Agregar Tarea Pendiente</h3>
      </div>
      <div className="space-y-3">
        ...
        <div>
          ...
          <Textarea
            placeholder="Describe qué harás para completar esta tarea"
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="hidden"
              aria-label="Seleccionar imagen para la tarea pendiente"
            />
            {formData.image && (
              <div className="mt-2">
                <img
